...
Design package lives in `docs/` (`USAGE.md`, `MODULES.md`, `DESIGN_TYPES.ts`). Implementation must match USAGE call sites and encode confidence `> 0.70` via branded `HighConfidence`.
